...
class Encoder(nn.Module):
    ...
    def __init__(
        ...
        **ignore_kwargs,
        ...
        self.conv_out_reshape = torch.nn.Conv2d(
...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        **ignorekwargs,
        ...
        self.conv_in_reshape = torch.nn.ConvTranspose2d(block_in, block_in, kernel_size=5, stride=1)           # [28, 28] -> [32,32]
